...
const portfolioData = {
  ...
  contact: {
    ...
    linkedin: "https://www.linkedin.com/in/sumaiya-shaikh-/",
  ...
  skills: {
    "Programming & Scripting": ["Python", "Java", "JavaScript", "UNIX", "SQL", "MongoDB"],
    "Machine Learning & AI": ["NLP", "Deep Learning", "LLM Integration", "PyTorch", "TensorFlow", "LangChain"],
    "Data Engineering": ["ETL", "PySpark", "Databricks", "Apache Spark", "Snowflake", "Kafka"],
    "Cloud & DevOps": ["AWS", "GCP", "Docker", "Kubernetes", "CI/CD", "Terraform"],
    "Web & API Development": ["Django REST", "Spring Boot", "React.js", "Tailwind CSS", "GraphQL"],
  },
  education: {
  ...
  >
        <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <Button href="#projects" variant="ghost">View My Work</Button>
            </div>
      </div>
    </Section>
  );
            ...
            {Object.entries(skills).map(([category, skillList]) => (
                <div key={category} className="bg-white p-6 rounded-lg shadow-sm border border-black/5">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {skillList.map(skill => (
                            <span key={skill} className="bg-taupe-300/40 text-indigo-900 text-sm font-medium px-3 py-1 rounded-full">
                                {skill}
                            </span>
                        ))}
                    </div>
            ...
            <div className="relative rounded-2xl p-8 md:p-12 text-white overflow-hidden bg-gradient-to-br from-violet-600 to-indigo-900 shadow-xl">
                <div className="flex flex-col lg:flex-row justify-between items-center text-center lg:text-left gap-6">
                    ...
                    <div className="flex-shrink-0">
                        <Button href={`mailto:${portfolioData.contact.email}`} variant="primary">Email Me</Button>
                    </div>
                </div>
            </div>
        </div>
...
const Footer = ({ name }) => {
  ...
  return (
    <footer className="bg-indigo-900 text-offwhite/70 py-8 mt-12">
